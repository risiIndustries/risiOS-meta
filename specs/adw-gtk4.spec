...
sed -i '1s/^/@import url("/usr/share/themes/adw-gtk3-dark/gtk-4.0/defaults-dark.css");' %{buildroot}%{_datadir}/themes/adw-gtk3/gtk-4.0/gtk.css
sed -i '1s/^/@import url("/usr/share/themes/adw-gtk3-dark/gtk-4.0/defaults-dark.css");' %{buildroot}%{_datadir}/themes/adw-gtk3-dark/gtk-4.0/gtk.css
